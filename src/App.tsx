...
const NexusSearchPage: React.FC<{ 
  ...
  accent: string 
    ...
    return (
        <div className="nexus-new-tab-page premium-ntp">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="search-container">
                ...
                <form className="search-box-ntp" onSubmit={(e) => { e.preventDefault(); onSearch(q); }}>
                    <Search size={20} className="search-icon-ntp" />
                    <input type="text" placeholder="Pesquise no Google..." value={q} onChange={(e) => setQ(e.target.value)} />
                </form>
            </motion.div>
